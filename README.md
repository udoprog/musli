...
* `rt/large` - which is roundtrip encoding of a large object, containing vectors
  and maps of other objects.

<img src="https://raw.githubusercontent.com/udoprog/musli/main/images/rt-large.png" alt="Roundtrip of a large object">
...
| **framework** | **primitives** | **large** | **allocated** | **medium_enum** |
| - | - | - | - | - |
