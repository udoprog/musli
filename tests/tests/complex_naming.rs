...
#[test]
fn bytes_tag_vec() {
    tests::rt!(full, CustomBytesVec(b"hello world".to_vec()));
}
...
fn enum_unsized_bytes() {
    tests::rt!(no_json, EnumUnsizedBytes::Variant1 { field1: 42 });
    tests::rt!(no_json, EnumUnsizedBytes::Variant2 { field2: 84 });
}
