...
fn grow_last() {
    ...
    let a = BufVec::new::<u8>(&alloc).unwrap();

    let mut b = BufVec::new::<u8>(&alloc).unwrap();
    b.write(&[1, 2, 3, 4, 5, 6]);
    b.write(&[7, 8]);
...
fn realloc() {
    ...
    let mut a = BufVec::new::<u8>(&alloc).unwrap();
    a.write(&[1, 2, 3, 4]);
    ...
    let mut c = BufVec::new::<u8>(&alloc).unwrap();
    c.write(&[1, 2, 3, 4]);
    ...
    let mut d = BufVec::new::<u8>(&alloc).unwrap();
...
fn grow_empty_moved() {
    ...
    let mut a = BufVec::new::<u8>(&alloc).unwrap();
    let b = BufVec::new::<u8>(&alloc).unwrap();
    let mut c = BufVec::new::<u8>(&alloc).unwrap();
