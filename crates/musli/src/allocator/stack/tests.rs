...
fn grow_last() {
    ...
    let a = BufVec::<u8, _>::new_in(&alloc);

    let mut b = BufVec::<u8, _>::new_in(&alloc);
    b.write(&[1, 2, 3, 4, 5, 6]);
    b.write(&[7, 8]);
...
fn realloc() {
    ...
    let mut a = BufVec::<u8, _>::new_in(&alloc);
    a.write(&[1, 2, 3, 4]);
    ...
    let mut c = BufVec::<u8, _>::new_in(&alloc);
    c.write(&[1, 2, 3, 4]);
    ...
    let mut d = BufVec::<u8, _>::new_in(&alloc);
...
fn grow_empty_moved() {
    ...
    let mut a = BufVec::<u8, _>::new_in(&alloc);
    let b = BufVec::<u8, _>::new_in(&alloc);
    let mut c = BufVec::<u8, _>::new_in(&alloc);
