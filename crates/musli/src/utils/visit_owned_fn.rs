...
///         D: Decoder<'de>,
///     {
///         decoder.decode_string(musli::utils::visit_owned_fn("A string variant for Enum", |variant: &str| {
///             match variant {
///                 "A" => Ok(Enum::A),
///                 "B" => Ok(Enum::A),
    ...
    T: ?Sized + ToOwned,
{
    ...
    #[inline]
    fn visit_ref(self, _: &C, string: &T) -> Result<Self::Ok, C::Error> {
