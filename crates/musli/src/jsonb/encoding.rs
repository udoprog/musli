...
use super::de::UntypedDecoder;
use super::en::JsonbEncoder;
#[cfg(feature = "alloc")]
use super::error::Error;

/// The default options for the jsonb encoding.
///
...
crate::macros::bare_encoding!(Binary, DEFAULT, jsonb, IntoReader, IntoWriter);
    ...
    M: 'static,
{
    ...
    ///
    /// ```
    /// use musli::jsonb::{OPTIONS, Encoding};
    ///
    /// enum Custom {}
    ///
    ...
    crate::macros::encoding_impls!(
        M,
        jsonb,
        JsonbEncoder::<OPT, _, _, M>::new,
        UntypedDecoder::<OPT, _, _, M>::new,
