...
- [**BSON serialization**](#bson) ([Full report](https://udoprog.github.io/musli/benchmarks/criterion-bson/report/))
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **987.35ns** ± 0.74ns | 986.10ns &mdash; 988.98ns |
| `musli_storage` | **427.30ns** ± 0.42ns | 426.54ns &mdash; 428.18ns |
| `musli_storage_packed` | **93.11ns** ± 0.09ns | 92.95ns &mdash; 93.29ns |
| `musli_value`[^musli_value] | **395.31ns** ± 0.28ns | 394.86ns &mdash; 395.96ns |
| `musli_wire` | **810.74ns** ± 0.57ns | 809.76ns &mdash; 811.98ns |
| `postcard` | **256.20ns** ± 0.18ns | 255.91ns &mdash; 256.59ns |
| `serde_bincode` | **80.02ns** ± 0.08ns | 79.87ns &mdash; 80.19ns |
| `serde_bitcode` | **1.29μs** ± 0.97ns | 1.29μs &mdash; 1.29μs |
| `serde_rmp` | **327.66ns** ± 0.22ns | 327.30ns &mdash; 328.16ns |
<table>
<tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **866.52ns** ± 1.03ns | 864.93ns &mdash; 868.87ns |
| `musli_storage` | **291.75ns** ± 0.25ns | 291.31ns &mdash; 292.30ns |
| `musli_storage_packed` | **132.40ns** ± 0.08ns | 132.27ns &mdash; 132.58ns |
| `musli_value`[^musli_value] | **1.03μs** ± 0.75ns | 1.03μs &mdash; 1.03μs |
| `musli_wire` | **764.95ns** ± 0.72ns | 763.71ns &mdash; 766.52ns |
| `postcard` | **434.49ns** ± 0.27ns | 434.06ns &mdash; 435.10ns |
| `serde_bincode` | **104.56ns** ± 0.11ns | 104.42ns &mdash; 104.80ns |
| `serde_bitcode` | **4.15μs** ± 4.90ns | 4.15μs &mdash; 4.17μs |
| `serde_rmp` | **226.29ns** ± 0.20ns | 225.93ns &mdash; 226.72ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **976.04ns** ± 0.71ns | 974.85ns &mdash; 977.60ns |
| `musli_storage` | **488.79ns** ± 0.66ns | 487.62ns &mdash; 490.19ns |
| `musli_storage_packed` | **488.54ns** ± 0.42ns | 487.79ns &mdash; 489.44ns |
| `musli_value`[^musli_value] | **462.10ns** ± 0.34ns | 461.60ns &mdash; 462.87ns |
| `musli_wire` | **829.16ns** ± 0.62ns | 828.10ns &mdash; 830.53ns |
| `postcard` | **249.88ns** ± 0.16ns | 249.63ns &mdash; 250.23ns |
| `serde_bincode` | **59.13ns** ± 0.05ns | 59.06ns &mdash; 59.23ns |
| `serde_bitcode` | **1.55μs** ± 1.25ns | 1.55μs &mdash; 1.56μs |
| `serde_rmp` | **427.54ns** ± 0.32ns | 427.00ns &mdash; 428.26ns |
<table>
<tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **872.05ns** ± 0.72ns | 870.77ns &mdash; 873.57ns |
| `musli_storage` | **231.91ns** ± 0.25ns | 231.58ns &mdash; 232.47ns |
| `musli_storage_packed` | **232.07ns** ± 0.17ns | 231.77ns &mdash; 232.44ns |
| `musli_value`[^musli_value] | **1.45μs** ± 1.24ns | 1.45μs &mdash; 1.45μs |
| `musli_wire` | **737.05ns** ± 0.77ns | 735.59ns &mdash; 738.61ns |
| `postcard` | **425.08ns** ± 0.49ns | 424.33ns &mdash; 426.20ns |
| `serde_bincode` | **124.58ns** ± 0.09ns | 124.43ns &mdash; 124.78ns |
| `serde_bitcode` | **4.67μs** ± 6.05ns | 4.66μs &mdash; 4.68μs |
| `serde_rmp` | **253.75ns** ± 0.19ns | 253.44ns &mdash; 254.15ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **2.27μs** ± 2.72ns | 2.27μs &mdash; 2.28μs |
| `musli_storage` | **1.18μs** ± 1.06ns | 1.18μs &mdash; 1.18μs |
| `musli_storage_packed` | **841.56ns** ± 0.53ns | 840.65ns &mdash; 842.71ns |
| `musli_value`[^musli_value] | **1.02μs** ± 0.78ns | 1.02μs &mdash; 1.02μs |
| `musli_wire` | **1.84μs** ± 1.72ns | 1.83μs &mdash; 1.84μs |
| `postcard` | **1.19μs** ± 0.93ns | 1.19μs &mdash; 1.20μs |
| `serde_bincode` | **865.94ns** ± 0.75ns | 864.81ns &mdash; 867.64ns |
| `serde_bitcode` | **9.19μs** ± 7.68ns | 9.18μs &mdash; 9.21μs |
| `serde_rmp` | **2.40μs** ± 2.60ns | 2.39μs &mdash; 2.40μs |
<table>
<tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **1.59μs** ± 1.24ns | 1.59μs &mdash; 1.59μs |
| `musli_storage` | **666.40ns** ± 0.71ns | 665.16ns &mdash; 667.91ns |
| `musli_storage_packed` | **500.13ns** ± 0.37ns | 499.53ns &mdash; 500.96ns |
| `musli_value`[^musli_value] | **3.21μs** ± 2.95ns | 3.21μs &mdash; 3.22μs |
| `musli_wire` | **1.40μs** ± 1.07ns | 1.40μs &mdash; 1.40μs |
| `postcard` | **915.61ns** ± 0.94ns | 913.87ns &mdash; 917.55ns |
| `serde_bincode` | **297.82ns** ± 0.23ns | 297.50ns &mdash; 298.35ns |
| `serde_bitcode` | **13.53μs** ± 10.26ns | 13.51μs &mdash; 13.55μs |
| `serde_rmp` | **753.63ns** ± 1.12ns | 751.53ns &mdash; 755.91ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **273.87μs** ± 257.28ns | 273.45μs &mdash; 274.45μs |
| `musli_storage` | **88.65μs** ± 75.53ns | 88.55μs &mdash; 88.83μs |
| `musli_storage_packed` | **46.60μs** ± 54.82ns | 46.51μs &mdash; 46.72μs |
| `musli_value`[^musli_value] | **118.19μs** ± 354.91ns | 117.56μs &mdash; 118.95μs |
| `musli_wire` | **258.39μs** ± 323.17ns | 257.94μs &mdash; 259.12μs |
| `postcard` | **86.72μs** ± 120.57ns | 86.53μs &mdash; 86.99μs |
| `serde_bincode` | **59.81μs** ± 60.72ns | 59.72μs &mdash; 59.95μs |
| `serde_bitcode` | **98.32μs** ± 127.63ns | 98.08μs &mdash; 98.58μs |
| `serde_rmp` | **231.02μs** ± 307.99ns | 230.55μs &mdash; 231.73μs |
<table>
<tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **187.44μs** ± 193.82ns | 187.14μs &mdash; 187.88μs |
| `musli_storage` | **63.99μs** ± 52.61ns | 63.89μs &mdash; 64.10μs |
| `musli_storage_packed` | **29.66μs** ± 19.29ns | 29.63μs &mdash; 29.70μs |
| `musli_value`[^musli_value] | **709.06μs** ± 1.10μs | 707.52μs &mdash; 711.56μs |
| `musli_wire` | **159.80μs** ± 145.78ns | 159.58μs &mdash; 160.14μs |
| `postcard` | **112.61μs** ± 234.80ns | 112.23μs &mdash; 113.14μs |
| `serde_bincode` | **40.23μs** ± 32.08ns | 40.18μs &mdash; 40.30μs |
| `serde_bitcode` | **117.70μs** ± 98.32ns | 117.54μs &mdash; 117.92μs |
| `serde_rmp` | **128.16μs** ± 153.02ns | 127.92μs &mdash; 128.51μs |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **3.48μs** ± 3.35ns | 3.47μs &mdash; 3.48μs |
| `musli_storage` | **3.05μs** ± 3.79ns | 3.04μs &mdash; 3.06μs |
| `musli_storage_packed` | **2.57μs** ± 2.33ns | 2.57μs &mdash; 2.58μs |
| `musli_value`[^musli_value] | **2.17μs** ± 2.14ns | 2.17μs &mdash; 2.18μs |
| `musli_wire` | **3.67μs** ± 4.11ns | 3.66μs &mdash; 3.68μs |
| `postcard` | **3.42μs** ± 3.74ns | 3.41μs &mdash; 3.43μs |
| `serde_bincode` | **3.18μs** ± 4.51ns | 3.17μs &mdash; 3.19μs |
| `serde_bitcode` | **5.72μs** ± 5.55ns | 5.71μs &mdash; 5.73μs |
| `serde_rmp` | **4.34μs** ± 3.55ns | 4.33μs &mdash; 4.34μs |
<table>
<tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **823.57ns** ± 0.58ns | 822.66ns &mdash; 824.86ns |
| `musli_storage` | **396.47ns** ± 0.41ns | 395.83ns &mdash; 397.40ns |
| `musli_storage_packed` | **320.81ns** ± 0.27ns | 320.36ns &mdash; 321.40ns |
| `musli_value`[^musli_value] | **2.38μs** ± 2.35ns | 2.38μs &mdash; 2.39μs |
| `musli_wire` | **756.17ns** ± 0.62ns | 755.01ns &mdash; 757.46ns |
| `postcard` | **1.21μs** ± 1.09ns | 1.20μs &mdash; 1.21μs |
| `serde_bincode` | **315.46ns** ± 0.65ns | 314.43ns &mdash; 316.92ns |
| `serde_bitcode` | **8.23μs** ± 7.18ns | 8.21μs &mdash; 8.24μs |
| `serde_rmp` | **764.84ns** ± 0.58ns | 763.86ns &mdash; 766.12ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **3.24μs** ± 2.66ns | 3.24μs &mdash; 3.25μs |
| `serde_json` | **4.50μs** ± 4.03ns | 4.49μs &mdash; 4.51μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primitives</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **761.75ns** ± 0.60ns | 760.85ns &mdash; 763.12ns |
| `serde_json` | **1.30μs** ± 1.56ns | 1.30μs &mdash; 1.31μs |
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **3.95μs** ± 3.58ns | 3.94μs &mdash; 3.95μs |
| `serde_json` | **4.72μs** ± 5.13ns | 4.71μs &mdash; 4.73μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primpacked</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **828.99ns** ± 0.74ns | 827.78ns &mdash; 830.62ns |
| `serde_json` | **1.39μs** ± 1.19ns | 1.39μs &mdash; 1.39μs |
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **8.73μs** ± 12.07ns | 8.71μs &mdash; 8.76μs |
| `serde_json` | **8.64μs** ± 7.01ns | 8.63μs &mdash; 8.66μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>medium_enum</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **1.86μs** ± 1.70ns | 1.85μs &mdash; 1.86μs |
| `serde_json` | **2.59μs** ± 2.25ns | 2.58μs &mdash; 2.59μs |
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **1.01ms** ± 1.19μs | 1.01ms &mdash; 1.01ms |
| `serde_json` | **758.72μs** ± 593.30ns | 757.82μs &mdash; 760.06μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>large</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **246.15μs** ± 188.86ns | 245.89μs &mdash; 246.59μs |
| `serde_json` | **305.17μs** ± 389.84ns | 304.58μs &mdash; 306.06μs |
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **9.27μs** ± 10.87ns | 9.25μs &mdash; 9.29μs |
| `serde_json` | **8.71μs** ± 8.51ns | 8.70μs &mdash; 8.73μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>allocated</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_json` | **2.28μs** ± 1.91ns | 2.28μs &mdash; 2.29μs |
| `serde_json` | **2.53μs** ± 2.29ns | 2.52μs &mdash; 2.53μs |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **778.81ns** ± 0.67ns | 777.64ns &mdash; 780.25ns |
| `musli_storage` | **374.55ns** ± 0.56ns | 373.66ns &mdash; 375.83ns |
| `musli_storage_packed` | **88.33ns** ± 0.07ns | 88.19ns &mdash; 88.47ns |
| `musli_value`[^musli_value] | **347.65ns** ± 0.57ns | 346.54ns &mdash; 348.78ns |
| `musli_wire` | **671.31ns** ± 0.50ns | 670.48ns &mdash; 672.42ns |
| `serde_cbor` | **1.53μs** ± 3.86ns | 1.53μs &mdash; 1.54μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primitives</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **547.55ns** ± 0.59ns | 546.43ns &mdash; 548.75ns |
| `musli_storage` | **261.35ns** ± 0.29ns | 260.93ns &mdash; 262.01ns |
| `musli_storage_packed` | **124.50ns** ± 0.10ns | 124.33ns &mdash; 124.72ns |
| `musli_value`[^musli_value] | **1.02μs** ± 0.90ns | 1.02μs &mdash; 1.02μs |
| `musli_wire` | **420.67ns** ± 0.41ns | 419.91ns &mdash; 421.52ns |
| `serde_cbor` | **415.63ns** ± 0.47ns | 414.99ns &mdash; 416.70ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **801.35ns** ± 0.52ns | 800.50ns &mdash; 802.51ns |
| `musli_storage` | **399.25ns** ± 0.37ns | 398.60ns &mdash; 400.03ns |
| `musli_storage_packed` | **399.02ns** ± 0.33ns | 398.48ns &mdash; 399.74ns |
| `musli_value`[^musli_value] | **398.20ns** ± 0.29ns | 397.71ns &mdash; 398.85ns |
| `musli_wire` | **721.90ns** ± 0.54ns | 721.06ns &mdash; 723.13ns |
| `serde_cbor` | **1.67μs** ± 3.22ns | 1.66μs &mdash; 1.68μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primpacked</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **549.02ns** ± 0.58ns | 547.92ns &mdash; 550.21ns |
| `musli_storage` | **216.38ns** ± 0.15ns | 216.14ns &mdash; 216.71ns |
| `musli_storage_packed` | **216.29ns** ± 0.15ns | 216.05ns &mdash; 216.62ns |
| `musli_value`[^musli_value] | **1.22μs** ± 0.90ns | 1.22μs &mdash; 1.22μs |
| `musli_wire` | **432.28ns** ± 0.39ns | 431.59ns &mdash; 433.10ns |
| `serde_cbor` | **484.65ns** ± 0.56ns | 483.65ns &mdash; 485.82ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **2.00μs** ± 2.22ns | 2.00μs &mdash; 2.01μs |
| `musli_storage` | **1.11μs** ± 0.69ns | 1.11μs &mdash; 1.11μs |
| `musli_storage_packed` | **852.11ns** ± 0.62ns | 851.08ns &mdash; 853.50ns |
| `musli_value`[^musli_value] | **969.51ns** ± 1.11ns | 967.62ns &mdash; 971.91ns |
| `musli_wire` | **1.63μs** ± 1.33ns | 1.62μs &mdash; 1.63μs |
| `serde_cbor` | **4.22μs** ± 5.06ns | 4.21μs &mdash; 4.23μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>medium_enum</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **1.29μs** ± 1.07ns | 1.29μs &mdash; 1.30μs |
| `musli_storage` | **650.10ns** ± 0.88ns | 648.84ns &mdash; 652.10ns |
| `musli_storage_packed` | **510.84ns** ± 0.51ns | 509.92ns &mdash; 511.90ns |
| `musli_value`[^musli_value] | **3.21μs** ± 2.99ns | 3.21μs &mdash; 3.22μs |
| `musli_wire` | **1.05μs** ± 0.89ns | 1.05μs &mdash; 1.05μs |
| `serde_cbor` | **975.60ns** ± 1.35ns | 973.36ns &mdash; 978.58ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **302.12μs** ± 150.58ns | 301.87μs &mdash; 302.45μs |
| `musli_storage` | **97.67μs** ± 69.94ns | 97.55μs &mdash; 97.82μs |
| `musli_storage_packed` | **39.70μs** ± 28.08ns | 39.65μs &mdash; 39.76μs |
| `musli_value`[^musli_value] | **129.57μs** ± 377.29ns | 128.94μs &mdash; 130.41μs |
| `musli_wire` | **273.02μs** ± 246.72ns | 272.58μs &mdash; 273.54μs |
| `serde_cbor` | **500.50μs** ± 813.65ns | 499.32μs &mdash; 502.37μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>large</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **204.66μs** ± 181.63ns | 204.40μs &mdash; 205.08μs |
| `musli_storage` | **76.30μs** ± 80.56ns | 76.17μs &mdash; 76.48μs |
| `musli_storage_packed` | **35.90μs** ± 23.43ns | 35.87μs &mdash; 35.95μs |
| `musli_value`[^musli_value] | **760.74μs** ± 699.21ns | 759.64μs &mdash; 762.32μs |
| `musli_wire` | **172.53μs** ± 120.83ns | 172.33μs &mdash; 172.80μs |
| `serde_cbor` | **165.38μs** ± 124.55ns | 165.19μs &mdash; 165.66μs |
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **2.42μs** ± 2.87ns | 2.41μs &mdash; 2.42μs |
| `musli_storage` | **2.08μs** ± 2.86ns | 2.07μs &mdash; 2.08μs |
| `musli_storage_packed` | **1.83μs** ± 1.62ns | 1.82μs &mdash; 1.83μs |
| `musli_value`[^musli_value] | **1.49μs** ± 1.35ns | 1.49μs &mdash; 1.50μs |
| `musli_wire` | **2.49μs** ± 2.84ns | 2.48μs &mdash; 2.49μs |
| `serde_cbor` | **5.05μs** ± 4.00ns | 5.05μs &mdash; 5.06μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>allocated</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_descriptive` | **622.80ns** ± 1.06ns | 620.98ns &mdash; 625.11ns |
| `musli_storage` | **311.08ns** ± 0.23ns | 310.71ns &mdash; 311.60ns |
| `musli_storage_packed` | **246.78ns** ± 0.18ns | 246.47ns &mdash; 247.18ns |
| `musli_value`[^musli_value] | **1.95μs** ± 2.39ns | 1.94μs &mdash; 1.95μs |
| `musli_wire` | **521.33ns** ± 0.40ns | 520.60ns &mdash; 522.16ns |
| `serde_cbor` | **613.58ns** ± 0.40ns | 612.92ns &mdash; 614.46ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_zerocopy` | **4.39ns** ± 0.00ns | 4.38ns &mdash; 4.39ns |
| `rkyv` | **11.09ns** ± 0.01ns | 11.08ns &mdash; 11.13ns |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primitives</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_zerocopy` | **18.67ns** ± 0.02ns | 18.63ns &mdash; 18.71ns |
| `rkyv` | **17.99ns** ± 0.01ns | 17.96ns &mdash; 18.02ns |
...
| Group | Mean | Interval
|-|-|-|
| `musli_zerocopy` | **2.63ns** ± 0.00ns | 2.63ns &mdash; 2.64ns |
| `rkyv` | **8.77ns** ± 0.01ns | 8.76ns &mdash; 8.78ns |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primpacked</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_zerocopy` | **17.23ns** ± 0.02ns | 17.20ns &mdash; 17.27ns |
| `rkyv` | **13.37ns** ± 0.01ns | 13.36ns &mdash; 13.39ns |
...
|-|-|-|
| `musli_zerocopy` | **2.63ns** ± 0.00ns | 2.63ns &mdash; 2.64ns |
| `zerocopy` | **5.26ns** ± 0.00ns | 5.26ns &mdash; 5.27ns |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primpacked</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `musli_zerocopy` | **18.44ns** ± 0.02ns | 18.41ns &mdash; 18.47ns |
| `zerocopy` | **7.94ns** ± 0.01ns | 7.93ns &mdash; 7.95ns |
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **245.41ns** ± 0.26ns | 245.00ns &mdash; 246.01ns |
| `musli_descriptive` | **987.51ns** ± 0.73ns | 986.43ns &mdash; 989.18ns |
| `musli_storage` | **425.46ns** ± 0.44ns | 424.69ns &mdash; 426.41ns |
| `musli_storage_packed` | **93.95ns** ± 0.14ns | 93.71ns &mdash; 94.26ns |
| `musli_wire` | **904.91ns** ± 1.31ns | 902.86ns &mdash; 907.88ns |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primitives</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **1.28μs** ± 0.94ns | 1.27μs &mdash; 1.28μs |
| `musli_descriptive` | **863.80ns** ± 0.61ns | 862.80ns &mdash; 865.18ns |
| `musli_storage` | **292.02ns** ± 0.30ns | 291.53ns &mdash; 292.67ns |
| `musli_storage_packed` | **132.54ns** ± 0.12ns | 132.34ns &mdash; 132.80ns |
| `musli_wire` | **765.42ns** ± 1.00ns | 763.59ns &mdash; 767.50ns |
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **244.16ns** ± 0.17ns | 243.90ns &mdash; 244.54ns |
| `musli_descriptive` | **972.94ns** ± 1.12ns | 971.37ns &mdash; 975.49ns |
| `musli_storage` | **488.69ns** ± 0.90ns | 487.18ns &mdash; 490.66ns |
| `musli_storage_packed` | **487.37ns** ± 0.36ns | 486.73ns &mdash; 488.14ns |
| `musli_wire` | **916.50ns** ± 0.72ns | 915.35ns &mdash; 918.09ns |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primpacked</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **1.32μs** ± 1.71ns | 1.31μs &mdash; 1.32μs |
| `musli_descriptive` | **873.25ns** ± 0.96ns | 871.57ns &mdash; 875.29ns |
| `musli_storage` | **231.99ns** ± 0.18ns | 231.70ns &mdash; 232.40ns |
| `musli_storage_packed` | **230.61ns** ± 0.16ns | 230.35ns &mdash; 230.98ns |
| `musli_wire` | **736.92ns** ± 0.87ns | 735.29ns &mdash; 738.72ns |
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **3.27μs** ± 2.32ns | 3.27μs &mdash; 3.28μs |
| `musli_descriptive` | **2.44μs** ± 1.92ns | 2.44μs &mdash; 2.45μs |
| `musli_storage` | **1.36μs** ± 1.32ns | 1.36μs &mdash; 1.36μs |
| `musli_storage_packed` | **1.01μs** ± 1.11ns | 1.01μs &mdash; 1.02μs |
| `musli_wire` | **2.07μs** ± 1.82ns | 2.07μs &mdash; 2.08μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>medium_enum</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **13.23μs** ± 15.20ns | 13.21μs &mdash; 13.27μs |
| `musli_descriptive` | **1.58μs** ± 1.24ns | 1.57μs &mdash; 1.58μs |
| `musli_storage` | **669.16ns** ± 0.47ns | 668.37ns &mdash; 670.21ns |
| `musli_storage_packed` | **499.98ns** ± 0.42ns | 499.23ns &mdash; 500.86ns |
| `musli_wire` | **1.34μs** ± 1.36ns | 1.34μs &mdash; 1.34μs |
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **32.86μs** ± 39.23ns | 32.79μs &mdash; 32.95μs |
| `musli_descriptive` | **275.57μs** ± 180.35ns | 275.27μs &mdash; 275.97μs |
| `musli_storage` | **92.76μs** ± 64.70ns | 92.66μs &mdash; 92.91μs |
| `musli_storage_packed` | **50.48μs** ± 54.71ns | 50.38μs &mdash; 50.60μs |
| `musli_wire` | **258.42μs** ± 344.75ns | 257.97μs &mdash; 259.19μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>large</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **84.21μs** ± 151.77ns | 83.99μs &mdash; 84.55μs |
| `musli_descriptive` | **186.96μs** ± 166.31ns | 186.71μs &mdash; 187.34μs |
| `musli_storage` | **63.90μs** ± 55.40ns | 63.82μs &mdash; 64.03μs |
| `musli_storage_packed` | **29.68μs** ± 21.35ns | 29.64μs &mdash; 29.73μs |
| `musli_wire` | **159.80μs** ± 126.97ns | 159.60μs &mdash; 160.09μs |
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **3.95μs** ± 5.32ns | 3.94μs &mdash; 3.96μs |
| `musli_descriptive` | **3.90μs** ± 2.44ns | 3.90μs &mdash; 3.91μs |
| `musli_storage` | **3.27μs** ± 3.81ns | 3.26μs &mdash; 3.28μs |
| `musli_storage_packed` | **2.98μs** ± 1.97ns | 2.98μs &mdash; 2.99μs |
| `musli_wire` | **4.08μs** ± 3.36ns | 4.07μs &mdash; 4.08μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>allocated</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `derive_bitcode` | **7.02μs** ± 11.28ns | 7.00μs &mdash; 7.05μs |
| `musli_descriptive` | **808.57ns** ± 0.52ns | 807.71ns &mdash; 809.73ns |
| `musli_storage` | **374.40ns** ± 0.39ns | 373.75ns &mdash; 375.26ns |
| `musli_storage_packed` | **304.21ns** ± 0.20ns | 303.88ns &mdash; 304.65ns |
| `musli_wire` | **734.79ns** ± 0.71ns | 733.57ns &mdash; 736.33ns |
...
[Full report](https://udoprog.github.io/musli/benchmarks/criterion-bson/report/)
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **2.27μs** ± 4.40ns | 2.26μs &mdash; 2.28μs |
| `musli_descriptive` | **707.83ns** ± 0.67ns | 706.66ns &mdash; 709.28ns |
| `musli_storage` | **378.56ns** ± 0.47ns | 377.98ns &mdash; 379.60ns |
| `musli_storage_packed` | **82.90ns** ± 0.09ns | 82.79ns &mdash; 83.09ns |
| `musli_wire` | **643.86ns** ± 0.71ns | 642.88ns &mdash; 645.46ns |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primitives</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **1.32μs** ± 1.22ns | 1.31μs &mdash; 1.32μs |
| `musli_descriptive` | **532.31ns** ± 0.38ns | 531.65ns &mdash; 533.15ns |
| `musli_storage` | **257.45ns** ± 0.27ns | 257.05ns &mdash; 258.07ns |
| `musli_storage_packed` | **120.59ns** ± 0.08ns | 120.46ns &mdash; 120.77ns |
| `musli_wire` | **416.91ns** ± 0.47ns | 416.14ns &mdash; 417.97ns |
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **3.04μs** ± 4.75ns | 3.03μs &mdash; 3.05μs |
| `musli_descriptive` | **735.76ns** ± 0.55ns | 734.82ns &mdash; 736.95ns |
| `musli_storage` | **403.59ns** ± 0.26ns | 403.16ns &mdash; 404.17ns |
| `musli_storage_packed` | **404.12ns** ± 0.49ns | 403.29ns &mdash; 405.17ns |
| `musli_wire` | **696.79ns** ± 0.61ns | 695.97ns &mdash; 698.17ns |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>primpacked</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **2.24μs** ± 2.03ns | 2.24μs &mdash; 2.25μs |
| `musli_descriptive` | **546.46ns** ± 0.38ns | 545.84ns &mdash; 547.32ns |
| `musli_storage` | **213.73ns** ± 0.13ns | 213.51ns &mdash; 214.03ns |
| `musli_storage_packed` | **213.82ns** ± 0.17ns | 213.53ns &mdash; 214.20ns |
| `musli_wire` | **462.48ns** ± 0.51ns | 461.50ns &mdash; 463.49ns |
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **7.32μs** ± 10.08ns | 7.30μs &mdash; 7.34μs |
| `musli_descriptive` | **1.56μs** ± 2.12ns | 1.55μs &mdash; 1.56μs |
| `musli_storage` | **878.37ns** ± 1.33ns | 876.30ns &mdash; 881.38ns |
| `musli_storage_packed` | **583.09ns** ± 0.36ns | 582.53ns &mdash; 583.91ns |
| `musli_wire` | **1.32μs** ± 1.07ns | 1.32μs &mdash; 1.32μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>medium_enum</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **4.79μs** ± 4.23ns | 4.78μs &mdash; 4.79μs |
| `musli_descriptive` | **1.15μs** ± 0.80ns | 1.15μs &mdash; 1.15μs |
| `musli_storage` | **621.99ns** ± 0.37ns | 621.38ns &mdash; 622.81ns |
| `musli_storage_packed` | **401.14ns** ± 0.26ns | 400.71ns &mdash; 401.70ns |
| `musli_wire` | **840.45ns** ± 0.60ns | 839.53ns &mdash; 841.82ns |
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **1.56ms** ± 2.30μs | 1.56ms &mdash; 1.57ms |
| `musli_descriptive` | **359.97μs** ± 227.21ns | 359.59μs &mdash; 360.47μs |
| `musli_storage` | **148.37μs** ± 119.84ns | 148.18μs &mdash; 148.64μs |
| `musli_storage_packed` | **88.68μs** ± 69.49ns | 88.57μs &mdash; 88.84μs |
| `musli_wire` | **339.61μs** ± 460.64ns | 338.93μs &mdash; 340.67μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>large</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **895.49μs** ± 957.18ns | 893.98μs &mdash; 897.65μs |
| `musli_descriptive` | **232.10μs** ± 274.39ns | 231.71μs &mdash; 232.73μs |
| `musli_storage` | **87.55μs** ± 73.82ns | 87.45μs &mdash; 87.72μs |
| `musli_storage_packed` | **45.32μs** ± 35.26ns | 45.26μs &mdash; 45.40μs |
| `musli_wire` | **188.99μs** ± 208.58ns | 188.64μs &mdash; 189.44μs |
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **8.28μs** ± 7.23ns | 8.26μs &mdash; 8.29μs |
| `musli_descriptive` | **3.06μs** ± 3.34ns | 3.05μs &mdash; 3.07μs |
| `musli_storage` | **2.77μs** ± 4.56ns | 2.76μs &mdash; 2.78μs |
| `musli_storage_packed` | **2.55μs** ± 2.53ns | 2.54μs &mdash; 2.55μs |
| `musli_wire` | **2.95μs** ± 3.64ns | 2.94μs &mdash; 2.96μs |
<table>
<tr>
<th colspan="3"><code>enc</code> / <code>allocated</code></th>
</tr>
...
| Group | Mean | Interval
|-|-|-|
| `bson`[^bson] | **2.29μs** ± 1.49ns | 2.29μs &mdash; 2.29μs |
| `musli_descriptive` | **539.12ns** ± 0.41ns | 538.43ns &mdash; 540.01ns |
| `musli_storage` | **324.64ns** ± 0.33ns | 324.16ns &mdash; 325.39ns |
| `musli_storage_packed` | **259.29ns** ± 0.24ns | 258.88ns &mdash; 259.80ns |
| `musli_wire` | **433.67ns** ± 0.37ns | 433.00ns &mdash; 434.46ns |
